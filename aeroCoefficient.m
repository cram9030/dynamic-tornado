...
numAlpha = length(alphaRange);
numBeta = length(betaRange);
numAirSpeed = length(airSpeedRange);
            ...
            for j = 1:numTwist
                parfor i = 1:numAlpha
                    ...
                    for k = 1:length(masterGeo(j,i,g,m,n).Wings(1).wing.Flex)
                        ...
                        latticei(k) = generateLattice2015_11_18(geo,S_ref,C_ref,B_ref,mac_pos,masterState(j,i,g,m,n));
                    end
