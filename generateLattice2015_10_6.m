%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [lattice] = generateLattice2015_10_6(geo,S_ref,C_ref,B_ref,mac_pos,state)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k = 1:geo.nwing
    ...
    for i = 1:geo.Wings(k).wing.cordNum
        ...
        [xm,ym,zm,x1n,x2n,xTrailR,xTrailL,xLeadR,xLeadL,y1n,y2n,z1n,z2n,zTrailR,zTrailL,zLeadR,zLeadL] = spanWisePopulate(geo.Wings(k).wing,quartCord,threeQuartCord,trail,lead,xm,ym,zm,x1n,x2n,xTrailR,xTrailL,xLeadR,xLeadL,y1n,y2n,z1n,z2n,zTrailR,zTrailL,zLeadR,zLeadL);
    end
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [xm,ym,zm,x1n,x2n,xTrailR,xTrailL,xLeadR,xLeadL,y1n,y2n,z1n,z2n,zTrailR,zTrailL,zLeadR,zLeadL] = spanWisePopulate(wing,quartCord,threeQuartCord,trail,lead,xm,ym,zm,x1n,x2n,xTrailR,xTrailL,xLeadR,xLeadL,y1n,y2n,z1n,z2n,zTrailR,zTrailL,zLeadR,zLeadL)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
y1nTemp = [-flipud([cumsum(wing.L(length(wing.L)/2:end-1))]);[0;cumsum(wing.L(length(wing.L)/2:end-2))]+wing.start(2)];
y2nTemp = [-flipud([0;cumsum(wing.L(length(wing.L)/2:end-2))]);[cumsum(wing.L(length(wing.L)/2:end-1))]+wing.start(2)];
...
if isempty(wing.Controls)
    for j = 1:wing.SegNum
        ...
        if j < (wing.SegNum-1)/2+1
            ...
            if j == 1
                ym = [ym;-sum(wing.L)/2+wing.L(1)/2];
            else
                ym = [ym;ym(end)+wing.L(j-1)/2+wing.L(j)/2];
            end
        else
