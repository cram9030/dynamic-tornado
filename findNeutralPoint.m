%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [NP] = findNeutralPoint(delta,state,geo,lattice,ref)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
NP = fminsearch(@(x) findMDerv(x,a),.127);
...
[geo] = setupGeo2015_8_10(geo.ref_point,[x,0,0],geo.nwing,geo.Wings);
